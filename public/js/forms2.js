function virificar_empresa(form){
	...
	bloque_emp.each(function(index, el) {
		...
		$('#arreglo_empesa_caja').val($('#arreglo_empesa_caja').val() + '||');
		$('#arreglo_empesa_caja').val($('#arreglo_empesa_caja').val() + $(this).find('input[type=checkbox]').prop('checked'));
		...
		$('#arreglo_empesa_caja').val($('#arreglo_empesa_caja').val() + '||');
		$('#arreglo_empesa_caja').val($('#arreglo_empesa_caja').val() + $(this).find('input ,select')[7].value);
		$('#arreglo_empesa_caja').val($('#arreglo_empesa_caja').val() + '@@');
	});
}
